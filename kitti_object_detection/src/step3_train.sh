...
train_and_transfer 0.1 20 resnet_18 0.01 ../data/Kitti8_ROIs 512 ../output/classifier_resnet_18.pth ../output/loss_resnet_18.png neither Y
# train_and_transfer 0.1 20 se_resneXt 0.001 ../data/Kitti8_ROIs 256 ../output/classifier_se_resneXt.pth ../output/loss_se_resneXt.png neither Y
